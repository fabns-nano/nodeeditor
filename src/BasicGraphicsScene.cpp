...
BasicGraphicsScene::BasicGraphicsScene(AbstractGraphModel& graphModel,
  ...
  connect(&_graphModel, &AbstractGraphModel::modelReset, this,
...
BasicGraphicsScene::makeDraftConnection(
    ConnectionId const incompleteConnectionId) {
  _draftConnection =
      std::make_unique<ConnectionGraphicsObject>(*this, incompleteConnectionId);
